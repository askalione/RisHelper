...
namespace RisHelper
{
    public class RisRecord
    {
        ...
        /// Authors
        /// </summary>
        [Field(tag: "AU,A1,A2,A3,A4", converterType: typeof(RisRecordAuthorArrayFieldConverter))]
        public RisRecordAuthor[] Authors { get; set; } = [];
        /// <summary>
        /// Abstract
        /// </summary>
        [Field(tag: "AB")]
        ...
        /// Editor
        /// </summary>
        [Field(tag: "ED", converterType: typeof(StringArrayFieldConverter))]
        ...
        /// </summary>
        [Field(tag: "JA", converterType: typeof(StringArrayFieldConverter))]
        public string[] JournalAbbreviatedTitles { get; set; } = [];
        /// <summary>
        /// Journal/Periodical name: full format
        /// </summary>
        [Field(tag: "JF", converterType: typeof(StringArrayFieldConverter))]
        public string[] JournalFullTitles { get; set; } = [];
        /// <summary>
        /// Journal/Periodical name
        /// </summary>
        [Field(tag: "JO", converterType: typeof(StringArrayFieldConverter))]
        public string[] JournalTitles { get; set; } = [];
        /// <summary>
        /// Keywords
        /// </summary>
        [Field(tag: "KW", converterType: typeof(StringArrayFieldConverter))]
        ...
        /// Language
        /// </summary>
        [Field(tag: "LA", converterType: typeof(StringArrayFieldConverter))]
        ...
        /// ISBN/ISSN
        /// </summary>
        [Field(tag: "SN", converterType: typeof(StringArrayFieldConverter))]
        ...
        /// Short Titles
        /// </summary>
        [Field(tag: "ST", converterType: typeof(StringArrayFieldConverter))]
        public string[] ShortTitles { get; set; } = [];
        /// <summary>
        /// Primary Title
        /// </summary>
        [Field(tag: "TI,T1,T2,T3", converterType: typeof(RisRecordTitleArrayFieldConverter))]
        public RisRecordTitle[] Titles { get; set; } = [];
        /// <summary>
        /// Translated Title
        /// </summary>
        [Field(tag: "TT", converterType: typeof(StringArrayFieldConverter))]
        public string[] TranslatedTitles { get; set; } = [];
        /// <summary>
        /// URLs
        /// </summary>
        [Field(tag: "UR", converterType: typeof(StringArrayFieldConverter))]
